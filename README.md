...
צמיחה שנתית: באמצעות שימוש בפונקציות חלון  המודל חישב את אחוז הצמיחה השנתי של כל עובד. נמצא כי עובדים ותיקים (Years of Seniority) אינם בהכרח אלו עם אחוז הצמיחה הגבוה ביותר, מה שמרמז על פוטנציאל גבוה בקרב עובדים חדשים.
...
ETL & Cleaning: טיוב נתונים (Data Cleansing) הכולל האחדת שמות, חילוץ דומיינים מכתובות מייל וחישוב עמודות נגזרות (כמו ותק עובדים)
